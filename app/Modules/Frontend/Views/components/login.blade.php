...
<div class="white-popup mfp-with-anim mfp-hide gmz-popup-form" id="gmz-register-popup">
    <div class="popup-inner">
        ...
        <div class="popup-content">
            <form class="text-left gmz-form-action account-form" action="{{url('register')}}" method="POST" id="registration-form">
                @include('Frontend::components.loader')
                <div class="form">
                    <input type="hidden" name="isfr" value="1" />
                    <div class="row">
                    ...
                    <!-- reCAPTCHA Section -->
                    <div class="g-recaptcha field-wrapper mt-5" data-sitekey="{{ config('recaptcha.site_key') }}"></div>
